 ...
 * Objetivo: Archivo de cabecera con las funciones que determinan si una matriz es dispersa o no, analizando la proporción de elementos diferentes de cero en la matriz utilizando múltiples procesos para mejorar la eficiencia en el cálculo.
 *********************/
