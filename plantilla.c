 ...
 * Fecha: 25 - Julio - 2023
 * Autor: John Corredor
 * Tema: Versión inicial de Automatización de Compilación
 * Objetivo: Crear una aplicación de Multiplicación de Matrices 
 * en compilación separada (Automatización)
 * Se requiere que el tamaño de la matriz sea N*N (matrices 
 * cuadradas, a la vez que se ingresa por argumentos de entrada
 * el valor del tamaño de la matriz.
 ***************************************************************/
